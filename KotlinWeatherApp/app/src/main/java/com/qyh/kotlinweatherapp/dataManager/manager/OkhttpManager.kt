...
import com.qyh.kotlinweatherapp.WApp
...
class OkhttpManager {
    ...
    companion object{
        ...
        //设置缓存目录
        private val cacheDirectory = File(WApp.instance.getCacheDir().getAbsolutePath(), "MyCache")
        ...
        private val interceptor = object : Interceptor{
            ...
            override fun intercept(chain: Interceptor.Chain): Response {
                ...
                if (isNetworkReachable(WApp.instance)) {
